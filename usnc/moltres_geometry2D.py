...
def add_lines(f, d_x, x):
    ...
    f.write("Point(1) = { "+ str(x[0] + d_x/2) +", "+ str(x[1] + d) +", "+ str(x[2]) +", 1.0};\n")
    f.write("Point(2) = { "+ str(x[0] + d_x) +", "+ str(x[1]) +", "+ str(x[2]) +", 1.0};\n")
    f.write("Point(3) = { "+ str(x[0] + d_x/2) +", "+ str(x[1] - d) +", "+ str(x[2]) +", 1.0};\n")
    f.write("Point(4) = { "+ str(x[0] - d_x/2) +", "+ str(x[1] - d) +", "+ str(x[2]) +", 1.0};\n")
    f.write("Point(5) = { "+ str(x[0] - d_x) +", "+ str(x[1]) +", "+ str(x[2]) +", 1.0};\n")
    f.write("Point(6) = { "+ str(x[0] - d_x/2) +", "+ str(x[1] + d) +", "+ str(x[2]) +", 1.0};\n")
...
def place_fuel_assembly(f, d_x, rc, rf, p_c, x):
    c, l, ns, ls = add_lines(f, d_x, x)
...
def main():    
    ...
    x = [0, 0, 0]
    c, l, ns, ls = place_fuel_assembly(f, d_x, rc, rf, p_c, x)
    # x = [60, 0, 0]
    # c, l, ns, ls = place_fuel_assembly(f, d_x, rc, rf, p_c, x)
