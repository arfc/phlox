// This one works well. It's the input file for ex08.i. Produced by geometry 3D_extrude2.
SetFactory("OpenCASCADE");
//+
Circle(1) = { -2.0, -2.0, 0.0, 1, 0, 2*Pi};
Circle(2) = { 2.0, -2.0, 0.0, 1, 0, 2*Pi};
Circle(3) = { -2.0, 2.0, 0.0, 1, 0, 2*Pi};
Circle(4) = { 2.0, 2.0, 0.0, 1, 0, 2*Pi};
...
//+
Physical Surface("fuel_top") = {12, 13, 14, 15};
//+
Physical Surface("moderator_side") = {6};
//+
Physical Volume("fuel") = {2, 3, 4, 5};
//+
